...
fn test_all_gas_pids_roundtrip() {
    ...
    eprintln!(
        "\nGas bulk roundtrip: {passed} passed, {skipped} known-incomplete, {} total",
        all_pids.len()
    );
}
