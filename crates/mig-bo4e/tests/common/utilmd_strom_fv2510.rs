//! Test utilities for UTILMD Strom FV2510 message type.
//!
//! Mirrors the FV2504 UTILMD Strom config in `test_utils.rs` but points to
//! FV2510 MIG/AHB XMLs, schemas, and mappings. Same 187 PIDs, structurally
//! identical schemas (only `enum` metadata removed in FV2510).
...
pub const MIG_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2510/UTILMD_MIG_Strom_S2_1_außerordentlicheg_20251211.xml";
pub const AHB_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2510/UTILMD_AHB_Strom_2_1_außerordentliche_20251211.xml";
pub const FIXTURE_DIR: &str = "../../example_market_communication_bo4e_transactions/UTILMD/FV2510";
pub const GENERATED_FIXTURE_DIR: &str =
    "../../example_market_communication_bo4e_transactions/UTILMD/FV2510/generated_strom";
pub const MAPPINGS_BASE: &str = "../../mappings/FV2510/UTILMD_Strom";
pub const SCHEMA_DIR: &str = "../../crates/mig-types/src/generated/fv2510/utilmd/pids";

/// UTILMD Strom transaction group — SG4 (IDE-initiated transactions).
...
/// Discover generated fixture file for a Strom PID (single file: `{pid}.edi`).
