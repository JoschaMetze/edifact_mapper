//! MSCONS FV2510 test utilities.
//!
//! Mirrors FV2504 MSCONS config with FV2510 paths.
...
pub const MIG_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2510/MSCONS_MIG_2_4c_au\u{00df}erordentliche_20240726.xml";
pub const AHB_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2510/MSCONS_AHB_3_1f_Fehlerkorrektur_20250623.xml";
pub const FIXTURE_DIR: &str = "../../example_market_communication_bo4e_transactions/MSCONS/FV2510";
pub const MAPPINGS_BASE: &str = "../../mappings/FV2510/MSCONS";
pub const SCHEMA_DIR: &str = "../../crates/mig-types/src/generated/fv2510/mscons/pids";
