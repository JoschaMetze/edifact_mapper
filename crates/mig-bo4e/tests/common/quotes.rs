//! QUOTES-specific test utilities for mig-bo4e integration tests.
//!
//! Thin wrapper around `MessageTypeConfig` with QUOTES-specific constants.
...
pub const MIG_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2504/QUOTES_MIG_1_3a_Fehlerorrektur_20241213.xml";
pub const AHB_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2504/QUOTES_AHB_1_0_Fehlerkorrektur_20241213.xml";
pub const FIXTURE_DIR: &str = "../../example_market_communication_bo4e_transactions/QUOTES/FV2504";
pub const MAPPINGS_BASE: &str = "../../mappings/FV2504/QUOTES";
pub const SCHEMA_DIR: &str = "../../crates/mig-types/src/generated/fv2504/quotes/pids";

/// QUOTES transaction group — SG27 (LIN-initiated positions).
