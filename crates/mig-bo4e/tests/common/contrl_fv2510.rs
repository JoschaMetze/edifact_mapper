//! CONTRL FV2510 test utilities.
//!
//! Mirrors FV2504 CONTRL config with FV2510 paths.
//! CONTRL has no TOML mappings in FV2504 — only assembly/roundtrip.
//! FV2510 adds 3 TOML mapping files.
...
pub const MIG_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2510/CONTRL_MIG_2_0b_au\u{00df}erordentliche_20251211.xml";
pub const AHB_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2510/CONTRL_AHB_1_0_au\u{00df}erordentliche_20251211.xml";
pub const FIXTURE_DIR: &str = "../../example_market_communication_bo4e_transactions/CONTRL/FV2510";
pub const MAPPINGS_BASE: &str = "../../mappings/FV2510/CONTRL";
pub const SCHEMA_DIR: &str = "../../crates/mig-types/src/generated/fv2510/contrl/pids";
