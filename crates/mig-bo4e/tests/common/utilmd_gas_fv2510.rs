//! Test utilities for UTILMD Gas FV2510 message type.
//!
//! Mirrors the FV2504 UTILMD Gas config in `utilmd_gas.rs` but points to
//! FV2510 MIG/AHB XMLs, schemas, and mappings. Same 95 PIDs — Gas MIG/AHB
//! XMLs are byte-identical between FV2504 and FV2510.
...
pub const MIG_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2510/UTILMD_MIG_Gas_G1_0a_außerordendliche_20240726.xml";
pub const AHB_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2510/UTILMD_AHB_Gas_1_0a_außerordentliche_20240726.xml";
...
pub const GENERATED_FIXTURE_DIR: &str =
    "../../example_market_communication_bo4e_transactions/UTILMD/FV2510/generated_gas";
pub const MAPPINGS_BASE: &str = "../../mappings/FV2510/UTILMD_Gas";
