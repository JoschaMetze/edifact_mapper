//! ORDRSP-specific test utilities for mig-bo4e integration tests.
//!
//! Thin wrapper around `MessageTypeConfig` with ORDRSP-specific constants.
...
pub const MIG_XML_PATH: &str = "../../xml-migs-and-ahbs/FV2504/ORDRSP_MIG_1_4_20240619.xml";
pub const AHB_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2504/ORDRSP_AHB_1_0a_Fehlerkorrektur_20250417.xml";
pub const FIXTURE_DIR: &str = "../../example_market_communication_bo4e_transactions/ORDRSP/FV2504";
pub const MAPPINGS_BASE: &str = "../../mappings/FV2504/ORDRSP";
pub const SCHEMA_DIR: &str = "../../crates/mig-types/src/generated/fv2504/ordrsp/pids";

/// ORDRSP transaction group — SG27 (LIN-initiated positions).
