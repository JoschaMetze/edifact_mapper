//! IFTSTA FV2604 test utilities.
//!
//! Mirrors FV2510 IFTSTA config with FV2604 paths.
...
pub const MIG_XML_PATH: &str = "../../xml-migs-and-ahbs/FV2604/IFTSTA_MIG_2_0g_20250401.xml";
pub const AHB_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2604/IFTSTA_AHB_2_0h_Fehlerkorrektur_20250623.xml";
pub const FIXTURE_DIR: &str = "../../example_market_communication_bo4e_transactions/IFTSTA/FV2604";
pub const MAPPINGS_BASE: &str = "../../mappings/FV2604/IFTSTA";
pub const SCHEMA_DIR: &str = "../../crates/mig-types/src/generated/fv2604/iftsta/pids";
...
pub fn tx_group_for_pid(pid: &str) -> &'static str {
    if FAMILY_A_PIDS.contains(&pid) {
        "SG4"
    } else {
        "SG14"
