//! COMDIS-specific test utilities for mig-bo4e integration tests.
//!
//! Thin wrapper around `MessageTypeConfig` with COMDIS-specific constants.
...
pub const MIG_XML_PATH: &str = "../../xml-migs-and-ahbs/FV2504/COMDIS_MIG_1_0e__20240619.xml";
pub const AHB_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2504/COMDIS_AHB_1_0f_außerordentliche_20250131.xml";
pub const FIXTURE_DIR: &str = "../../example_market_communication_bo4e_transactions/COMDIS/FV2504";
pub const MAPPINGS_BASE: &str = "../../mappings/FV2504/COMDIS";
pub const SCHEMA_DIR: &str = "../../crates/mig-types/src/generated/fv2504/comdis/pids";
