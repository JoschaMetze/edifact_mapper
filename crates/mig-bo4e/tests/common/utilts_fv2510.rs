//! UTILTS FV2510 test utilities.
//!
//! Mirrors FV2504 UTILTS config with FV2510 paths.
...
pub const MIG_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2510/UTILTS_MIG_1.1e_Fehlerkorrektur_20241213.xml";
pub const AHB_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2510/UTILTS_AHB_1_0_Fehlerkorrektur_20251211.xml";
pub const FIXTURE_DIR: &str = "../../example_market_communication_bo4e_transactions/UTILTS/FV2510";
pub const MAPPINGS_BASE: &str = "../../mappings/FV2510/UTILTS";
pub const SCHEMA_DIR: &str = "../../crates/mig-types/src/generated/fv2510/utilts/pids";
