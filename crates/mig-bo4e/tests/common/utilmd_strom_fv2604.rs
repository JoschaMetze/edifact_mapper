//! Test utilities for UTILMD Strom FV2604 message type.
//!
//! Mirrors the FV2510 UTILMD Strom config but points to FV2604 MIG/AHB XMLs,
...
pub const MIG_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2604/UTILMD_MIG_Strom_S2_1_au\u{00df}erordentlicheg_20251211.xml";
pub const AHB_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2604/UTILMD_AHB_Strom_2_1_au\u{00df}erordentliche_20251211.xml";
...
pub const GENERATED_FIXTURE_DIR: &str =
    "../../example_market_communication_bo4e_transactions/UTILMD/FV2604/generated_strom";
pub const MAPPINGS_BASE: &str = "../../mappings/FV2604/UTILMD_Strom";
