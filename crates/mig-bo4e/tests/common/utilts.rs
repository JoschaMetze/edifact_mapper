//! UTILTS-specific test utilities for mig-bo4e integration tests.
//!
//! Thin wrapper around `MessageTypeConfig` with UTILTS-specific constants.
//! All 8 PIDs (25001, 25004–25010) share tx_group = "SG5" (IDE+24 entry segment).
...
pub const MIG_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2504/UTILTS_MIG_1_1e_Fehlerkorrektur_20241018.xml";
pub const AHB_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2504/UTILTS_AHB_1_0_Fehlerkorrektur_20250218.xml";
pub const FIXTURE_DIR: &str = "../../example_market_communication_bo4e_transactions/UTILTS/FV2504";
pub const MAPPINGS_BASE: &str = "../../mappings/FV2504/UTILTS";
pub const SCHEMA_DIR: &str = "../../crates/mig-types/src/generated/fv2504/utilts/pids";

/// UTILTS transaction group — SG5 (IDE+24 initiated transactions).
...
/// Discover generated fixture file for a UTILTS PID.
