//! REMADV-specific test utilities for mig-bo4e integration tests.
//!
//! Thin wrapper around `MessageTypeConfig` with REMADV-specific constants.
...
pub const MIG_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2504/REMADV_MIG_2_9c_außerordentliche_20240726.xml";
pub const AHB_XML_PATH: &str =
    "../../xml-migs-and-ahbs/FV2504/REMADV_AHB_2_5d_Fehlerkorrektur_20250623.xml";
pub const FIXTURE_DIR: &str = "../../example_market_communication_bo4e_transactions/REMADV/FV2504";
pub const MAPPINGS_BASE: &str = "../../mappings/FV2504/REMADV";
pub const SCHEMA_DIR: &str = "../../crates/mig-types/src/generated/fv2504/remadv/pids";

/// REMADV transaction group — SG5 (DOC-initiated document references).
