//! Bulk roundtrip tests for UTILMD Strom PIDs (FV2510).
//!
//! Uses generated fixtures from `example_market_communication_bo4e_transactions/UTILMD/FV2510/generated_strom/`.
...
//!
//! FV2510 schemas are structurally identical to FV2504 (same 187 PIDs, same field
//! paths). Only the `enum` metadata field was removed. TOML mappings are copied
//! from FV2504 and work unchanged.
//!
//! The 119 PIDs that were mapped using generated fixtures in FV2504 pass byte-identical.
//! The remaining 68 "original" PIDs (mapped with real fixtures) have SG8 ordering
//! tuned for real fixture segment order, which differs from generated fixture order.
//! These are tested for forward mapping only (not byte-identical roundtrip).

mod common;

use common::{bo4e_validation, test_utils, utilmd_strom_fv2510};
...
const GENERATED_FIXTURE_PIDS: &[&str] = &[
    "55039", "55040", "55041", "55043", "55044", "55051", "55052", "55053", "55060", "55062",
    "55063", "55064", "55065", "55066", "55067", "55069", "55070", "55071", "55072", "55073",
    "55074", "55075", "55076", "55077", "55078", "55080", "55095", "55168", "55169", "55170",
    "55173", "55177", "55194", "55195", "55196", "55197", "55198", "55199", "55200", "55201",
    "55202", "55203", "55204", "55205", "55206", "55207", "55208", "55209", "55210", "55211",
    "55212", "55213", "55214", "55223", "55224", "55227", "55230", "55235", "55236", "55237",
    "55238", "55239", "55240", "55241", "55242", "55243", "55557", "55559", "55601", "55603",
    "55605", "55607", "55608", "55609", "55611", "55613", "55614", "55619", "55625", "55627",
    "55628", "55629", "55630", "55632", "55633", "55634", "55635", "55636", "55638", "55639",
    "55642", "55644", "55645", "55647", "55652", "55657", "55659", "55660", "55661", "55662",
    "55663", "55664", "55665", "55666", "55667", "55669", "55670", "55671", "55672", "55673",
    "55674", "55675", "55684", "55685", "55686", "55687", "55688", "55689", "55690",
];

/// 68 "original" PIDs mapped with real fixtures — forward mapping validated, but
/// byte-identical roundtrip only works with real fixtures (SG8 ordering differs
/// in generated fixtures).
const ORIGINAL_PIDS: &[&str] = &[
    "55001", "55002", "55003", "55004", "55005", "55006", "55007", "55008", "55009", "55010",
    "55011", "55012", "55013", "55014", "55015", "55016", "55017", "55018", "55022", "55023",
    "55024", "55035", "55036", "55037", "55038", "55042", "55109", "55110", "55126", "55136",
    "55137", "55156", "55175", "55180", "55218", "55220", "55225", "55232", "55553", "55555",
    "55600", "55602", "55604", "55615", "55616", "55617", "55618", "55620", "55621", "55622",
    "55623", "55624", "55626", "55640", "55641", "55643", "55646", "55648", "55649", "55650",
    "55651", "55653", "55654", "55655", "55656", "55658", "55691", "55692",
];

#[test]
fn test_generated_fixture_pids_roundtrip() {
    assert_eq!(
        GENERATED_FIXTURE_PIDS.len(),
        119,
        "should cover all 119 generated-fixture PIDs"
    );

    let mut passed = 0;

    for pid in GENERATED_FIXTURE_PIDS {
    ...
    eprintln!(
        "\nStrom FV2510 generated-fixture PIDs: {passed} passed, {} total",
        GENERATED_FIXTURE_PIDS.len()
    );
}

#[test]
fn test_original_pids_forward_mapping() {
    assert_eq!(ORIGINAL_PIDS.len(), 68, "should cover all 68 original PIDs");

    let mut passed = 0;

    for pid in ORIGINAL_PIDS {
        run_forward_mapping_only(pid);
        passed += 1;
    }

    eprintln!(
        "\nStrom FV2510 original PIDs (forward only): {passed} passed, {} total",
        ORIGINAL_PIDS.len()
    );
}

#[test]
fn test_pid_count_coverage() {
    let total = GENERATED_FIXTURE_PIDS.len() + ORIGINAL_PIDS.len();
    assert_eq!(total, 187, "should cover all 187 Strom PIDs");
}
...
// ── Roundtrip helper (byte-identical) ──

fn run_generated_roundtrip(pid: &str) {
    let Some(fixture_path) = utilmd_strom_fv2510::discover_generated_fixture(pid) else {
        panic!("PID {pid}: no FV2510 generated fixture found");
    };

    let Some(filtered_mig) = utilmd_strom_fv2510::load_pid_filtered_mig(pid) else {
        panic!("PID {pid}: FV2510 MIG/AHB XML not available");
    };

    let tx_dir = utilmd_strom_fv2510::pid_dir(pid);
    if !utilmd_strom_fv2510::message_dir().exists() || !tx_dir.exists() {
        panic!("PID {pid}: FV2510 mapping directories not found");
    }
    let (msg_engine, tx_engine) = utilmd_strom_fv2510::load_split_engines(pid);
...
// ── Forward-only helper (validates mapping without byte-identical roundtrip) ──

fn run_forward_mapping_only(pid: &str) {
    let Some(fixture_path) = utilmd_strom_fv2510::discover_generated_fixture(pid) else {
        panic!("PID {pid}: no FV2510 generated fixture found");
    };
    ...
    // Reverse mapping should produce a tree (structural check, not byte-identical)
    ...
    assert!(
        ...
        "PID {pid} ({fixture_name}): reverse mapping should produce segments"
    );

    eprintln!(
        "PID {pid}: {fixture_name} -- forward OK, {} transactions, {} reverse segments",
