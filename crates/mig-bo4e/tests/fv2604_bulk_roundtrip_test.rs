...
fn test_fv2604_insrpt_all_pids_roundtrip() {
    let pids = ["23001", "23002", "23003", "23005", "23007", "23009", "23011", "23012"];
    run_all_generated_roundtrips("INSRPT", &pids, &[], |pid| {
        ...
        let (msg, tx) = common::insrpt_fv2604::load_engines_for_pid(pid);
...
fn test_fv2604_invoic_all_pids_roundtrip() {
    ...
    run_all_generated_roundtrips("INVOIC", &pids, &[], |pid| {
        ...
        let (msg, tx) = common::invoic_fv2604::load_engines_for_pid(pid);
...
fn test_fv2604_partin_all_pids_roundtrip() {
    let pids = [
        ...
        "37008", "37009", "37010", "37011", "37012", "37013", "37014",
    ];
    run_all_generated_roundtrips("PARTIN", &pids, &[], |pid| {
        ...
        let (msg, tx) = common::partin_fv2604::load_engines_for_pid(pid);
