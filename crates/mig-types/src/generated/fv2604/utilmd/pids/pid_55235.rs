...
impl Pid55235Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55235Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55235Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55235Sg5Z15::from_segments(segments, cursor) {
            sg5_z15.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55235Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z22 = Vec::new();
        while let Some(item) = Pid55235Sg8Z22::from_segments(segments, cursor) {
            sg8_z22.push(item);
        }
        let mut sg8_z23 = Vec::new();
        while let Some(item) = Pid55235Sg8Z23::from_segments(segments, cursor) {
            sg8_z23.push(item);
        }
        Some(Self {
            dtm,
...
impl Pid55235Sg8Z22 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55235Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self {
            rff,
...
impl Pid55235Sg8Z23 {
    ...
    pub fn from_segments(
        ...
        let mut sg9 = Vec::new();
        while let Some(item) = Pid55235Sg9::from_segments(segments, cursor) {
            sg9.push(item);
        }
        Some(Self {
            pia,
...
impl Pid55235 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55235Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55235Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
