...
impl Pid55661Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55661Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55661Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55661Sg5Z19::from_segments(segments, cursor) {
            sg5_z19.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55661Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z62 = Vec::new();
        while let Some(item) = Pid55661Sg8Z62::from_segments(segments, cursor) {
            sg8_z62.push(item);
        }
        let mut sg8_z61 = Vec::new();
        while let Some(item) = Pid55661Sg8Z61::from_segments(segments, cursor) {
            sg8_z61.push(item);
        }
        Some(Self {
            ide,
...
impl Pid55661Sg8Z61 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55661Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self {
            pia,
...
impl Pid55661 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55661Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55661Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
