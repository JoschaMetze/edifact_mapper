...
impl Pid55636Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55636Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55636Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55636Sg5Z19::from_segments(segments, cursor) {
            sg5_z19.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55636Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_zb1_zb2 = Vec::new();
        while let Some(item) = Pid55636Sg8Zb1Zb2::from_segments(segments, cursor) {
...
impl Pid55636Sg8Zb1Zb2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55636Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self {
            seq,
...
impl Pid55636 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55636Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55636Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
