...
impl Pid55621Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55621Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55621Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55621Sg5Z18::from_segments(segments, cursor) {
            sg5_z18.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55621Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_za9_zb0 = Vec::new();
        while let Some(item) = Pid55621Sg8Za9Zb0::from_segments(segments, cursor) {
...
impl Pid55621Sg8Za9Zb0 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55621Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self {
            seq,
...
impl Pid55621 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55621Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55621Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
