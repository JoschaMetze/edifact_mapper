...
impl Pid55630Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55630Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55630Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55630Sg5Z19::from_segments(segments, cursor) {
            sg5_z19.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55630Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z62 = Vec::new();
        while let Some(item) = Pid55630Sg8Z62::from_segments(segments, cursor) {
            sg8_z62.push(item);
        }
        Some(Self {
            ide,
...
impl Pid55630Sg8Z62 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55630Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self {
            seq,
...
impl Pid55630 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55630Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55630Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
