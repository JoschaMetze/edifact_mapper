//! Auto-generated PID 44024 types.
...
pub struct Pid44024Sg2 {
    pub nad: Option<OwnedSegment>,
    pub sg3_ic: Vec<Pid44024Sg3Ic>,
}

/// SG3 — Funktion des Ansprechpartners, Code
/// Qualifiers: IC
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid44024Sg3Ic {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid44024Sg4 {
    pub ftx: Option<OwnedSegment>,
    pub ide: Option<OwnedSegment>,
    pub sts: Option<OwnedSegment>,
    pub sg6: Vec<Pid44024Sg6>,
}

/// SG6 — Referenz, Qualifier
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid44024Sg6 {
    pub rff: Option<OwnedSegment>,
}

/// PID 44024: Ablehnung Anfrage Stornierung
...
pub struct Pid44024 {
    ...
    pub sg2: Vec<Pid44024Sg2>,
    pub sg4: Vec<Pid44024Sg4>,
}
...
impl Pid44024Sg2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid44024Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
...
impl Pid44024Sg4 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        let mut sg6 = Vec::new();
        while let Some(item) = Pid44024Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
...
impl Pid44024 {
    ...
    pub fn from_segments(segments: &[OwnedSegment]) -> Result<Self, SegmentNotFound> {
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid44024Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid44024Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
