...
impl Pid55043Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55043Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55043Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55043Sg12Z09::from_segments(segments, cursor) {
            sg12_z09.push(item);
        }
        let mut sg12_z04 = Vec::new();
        while let Some(item) = Pid55043Sg12Z04::from_segments(segments, cursor) {
            sg12_z04.push(item);
        }
        let mut sg12_z07 = Vec::new();
        while let Some(item) = Pid55043Sg12Z07::from_segments(segments, cursor) {
            sg12_z07.push(item);
        }
        let mut sg12_z08 = Vec::new();
        while let Some(item) = Pid55043Sg12Z08::from_segments(segments, cursor) {
            sg12_z08.push(item);
        }
        let mut sg12_z03 = Vec::new();
        while let Some(item) = Pid55043Sg12Z03::from_segments(segments, cursor) {
            sg12_z03.push(item);
        }
        let mut sg12_z05 = Vec::new();
        while let Some(item) = Pid55043Sg12Z05::from_segments(segments, cursor) {
            sg12_z05.push(item);
        }
        let mut sg5_z18 = Vec::new();
        while let Some(item) = Pid55043Sg5Z18::from_segments(segments, cursor) {
            sg5_z18.push(item);
        }
        let mut sg5_z16 = Vec::new();
        while let Some(item) = Pid55043Sg5Z16::from_segments(segments, cursor) {
            sg5_z16.push(item);
        }
        let mut sg5_z22 = Vec::new();
        while let Some(item) = Pid55043Sg5Z22::from_segments(segments, cursor) {
            sg5_z22.push(item);
        }
        let mut sg5_z20 = Vec::new();
        while let Some(item) = Pid55043Sg5Z20::from_segments(segments, cursor) {
            sg5_z20.push(item);
        }
        let mut sg5_z19 = Vec::new();
        while let Some(item) = Pid55043Sg5Z19::from_segments(segments, cursor) {
            sg5_z19.push(item);
        }
        let mut sg5_z21 = Vec::new();
        while let Some(item) = Pid55043Sg5Z21::from_segments(segments, cursor) {
            sg5_z21.push(item);
        }
        let mut sg5_z17 = Vec::new();
        while let Some(item) = Pid55043Sg5Z17::from_segments(segments, cursor) {
            sg5_z17.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55043Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z78 = Vec::new();
        while let Some(item) = Pid55043Sg8Z78::from_segments(segments, cursor) {
            sg8_z78.push(item);
        }
        let mut sg8_z58 = Vec::new();
        while let Some(item) = Pid55043Sg8Z58::from_segments(segments, cursor) {
            sg8_z58.push(item);
        }
        let mut sg8_z51 = Vec::new();
        while let Some(item) = Pid55043Sg8Z51::from_segments(segments, cursor) {
            sg8_z51.push(item);
        }
        let mut sg8_z57 = Vec::new();
        while let Some(item) = Pid55043Sg8Z57::from_segments(segments, cursor) {
            sg8_z57.push(item);
        }
        let mut sg8_z60 = Vec::new();
        while let Some(item) = Pid55043Sg8Z60::from_segments(segments, cursor) {
            sg8_z60.push(item);
        }
        let mut sg8_z01 = Vec::new();
        while let Some(item) = Pid55043Sg8Z01::from_segments(segments, cursor) {
            sg8_z01.push(item);
        }
        let mut sg8_z27 = Vec::new();
        while let Some(item) = Pid55043Sg8Z27::from_segments(segments, cursor) {
            sg8_z27.push(item);
        }
        let mut sg8_z02 = Vec::new();
        while let Some(item) = Pid55043Sg8Z02::from_segments(segments, cursor) {
            sg8_z02.push(item);
        }
        let mut sg8_z59 = Vec::new();
        while let Some(item) = Pid55043Sg8Z59::from_segments(segments, cursor) {
            sg8_z59.push(item);
        }
        let mut sg8_z15 = Vec::new();
        while let Some(item) = Pid55043Sg8Z15::from_segments(segments, cursor) {
            sg8_z15.push(item);
        }
        let mut sg8_z16 = Vec::new();
        while let Some(item) = Pid55043Sg8Z16::from_segments(segments, cursor) {
            sg8_z16.push(item);
        }
        let mut sg8_z52 = Vec::new();
        while let Some(item) = Pid55043Sg8Z52::from_segments(segments, cursor) {
            sg8_z52.push(item);
        }
        let mut sg8_z62 = Vec::new();
        while let Some(item) = Pid55043Sg8Z62::from_segments(segments, cursor) {
            sg8_z62.push(item);
        }
        let mut sg8_z61 = Vec::new();
        while let Some(item) = Pid55043Sg8Z61::from_segments(segments, cursor) {
            sg8_z61.push(item);
        }
        let mut sg8_z18 = Vec::new();
        while let Some(item) = Pid55043Sg8Z18::from_segments(segments, cursor) {
            sg8_z18.push(item);
        }
        let mut sg8_z19 = Vec::new();
        while let Some(item) = Pid55043Sg8Z19::from_segments(segments, cursor) {
            sg8_z19.push(item);
        }
        let mut sg8_z03 = Vec::new();
        while let Some(item) = Pid55043Sg8Z03::from_segments(segments, cursor) {
            sg8_z03.push(item);
        }
        let mut sg8_z20 = Vec::new();
        while let Some(item) = Pid55043Sg8Z20::from_segments(segments, cursor) {
            sg8_z20.push(item);
        }
        let mut sg8_z04 = Vec::new();
        while let Some(item) = Pid55043Sg8Z04::from_segments(segments, cursor) {
            sg8_z04.push(item);
        }
        let mut sg8_z05 = Vec::new();
        while let Some(item) = Pid55043Sg8Z05::from_segments(segments, cursor) {
            sg8_z05.push(item);
        }
        let mut sg8_z06 = Vec::new();
        while let Some(item) = Pid55043Sg8Z06::from_segments(segments, cursor) {
            sg8_z06.push(item);
        }
        let mut sg8_z13 = Vec::new();
        while let Some(item) = Pid55043Sg8Z13::from_segments(segments, cursor) {
            sg8_z13.push(item);
        }
        let mut sg8_z14 = Vec::new();
        while let Some(item) = Pid55043Sg8Z14::from_segments(segments, cursor) {
            sg8_z14.push(item);
        }
        let mut sg8_z21 = Vec::new();
        while let Some(item) = Pid55043Sg8Z21::from_segments(segments, cursor) {
            sg8_z21.push(item);
        }
        let mut sg8_z08 = Vec::new();
        while let Some(item) = Pid55043Sg8Z08::from_segments(segments, cursor) {
            sg8_z08.push(item);
        }
        let mut sg8_z38 = Vec::new();
        while let Some(item) = Pid55043Sg8Z38::from_segments(segments, cursor) {
            sg8_z38.push(item);
        }
        Some(Self {
            dtm,
...
impl Pid55043Sg8Z01 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55043Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        let mut sg9 = Vec::new();
        while let Some(item) = Pid55043Sg9::from_segments(segments, cursor) {
            sg9.push(item);
        }
        Some(Self {
            rff,
...
impl Pid55043 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55043Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55043Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
