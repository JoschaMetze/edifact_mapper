...
pub struct Pid55023Sg2 {
    pub nad: Option<OwnedSegment>,
    pub sg3_ic: Vec<Pid55023Sg3Ic>,
}

/// SG3 — Funktion des Ansprechpartners, Code
/// Qualifiers: IC
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55023Sg3Ic {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55023Sg4 {
    pub ide: Option<OwnedSegment>,
    pub sts: Option<OwnedSegment>,
    pub sg6: Vec<Pid55023Sg6>,
}

/// SG6 — Referenz, Qualifier
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55023Sg6 {
...
pub struct Pid55023 {
    ...
    pub sg2: Vec<Pid55023Sg2>,
    pub sg4: Vec<Pid55023Sg4>,
}
...
impl Pid55023Sg2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55023Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
...
impl Pid55023Sg4 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55023Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
...
impl Pid55023 {
    ...
    pub fn from_segments(segments: &[OwnedSegment]) -> Result<Self, SegmentNotFound> {
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55023Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55023Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
