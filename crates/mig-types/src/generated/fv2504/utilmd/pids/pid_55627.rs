...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55627Sg2 {
    pub nad: Option<OwnedSegment>,
    pub sg3_ic: Vec<Pid55627Sg3Ic>,
}

/// SG3 — Funktion des Ansprechpartners, Code
/// Qualifiers: IC
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55627Sg3Ic {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55627Sg4 {
    pub ide: Option<OwnedSegment>,
    pub sts: Option<OwnedSegment>,
    pub sg5_z18: Vec<Pid55627Sg5Z18>,
    pub sg6: Vec<Pid55627Sg6>,
    pub sg8_z51: Vec<Pid55627Sg8Z51>,
}

/// SG5 — Ortsangabe, Qualifier
/// Qualifiers: Z18
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55627Sg5Z18 {
    pub loc: Option<OwnedSegment>,
}

/// SG6 — Referenz, Qualifier
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55627Sg6 {
...
/// Qualifiers: Z51
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55627Sg8Z51 {
    pub seq: Option<OwnedSegment>,
    pub sg10: Vec<Pid55627Sg10>,
}
...
pub struct Pid55627 {
    ...
    pub sg2: Vec<Pid55627Sg2>,
    pub sg4: Vec<Pid55627Sg4>,
}
...
impl Pid55627Sg2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55627Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
...
impl Pid55627Sg4 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55627Sg5Z18::from_segments(segments, cursor) {
            sg5_z18.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55627Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z51 = Vec::new();
        while let Some(item) = Pid55627Sg8Z51::from_segments(segments, cursor) {
            sg8_z51.push(item);
        }
        Some(Self {
            ide,
...
impl Pid55627Sg8Z51 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55627Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self { seq, sg10 })
    }
...
impl Pid55627 {
    ...
    pub fn from_segments(segments: &[OwnedSegment]) -> Result<Self, SegmentNotFound> {
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55627Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55627Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
