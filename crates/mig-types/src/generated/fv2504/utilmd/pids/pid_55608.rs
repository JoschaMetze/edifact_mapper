...
impl Pid55608Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55608Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55608Sg4 {
    ...
    pub fn from_segments(
        ...
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55608Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z79 = Vec::new();
        while let Some(item) = Pid55608Sg8Z79::from_segments(segments, cursor) {
            sg8_z79.push(item);
        }
        let mut sg8_zh0 = Vec::new();
        while let Some(item) = Pid55608Sg8Zh0::from_segments(segments, cursor) {
            sg8_zh0.push(item);
        }
        Some(Self {
            dtm,
...
impl Pid55608Sg8Z79 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55608Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self {
            pia,
...
impl Pid55608 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55608Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55608Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
