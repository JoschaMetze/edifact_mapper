...
impl Pid55009Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55009Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55009Sg4 {
    ...
    pub fn from_segments(
        ...
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55009Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        Some(Self {
            ftx,
...
impl Pid55009 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55009Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55009Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
