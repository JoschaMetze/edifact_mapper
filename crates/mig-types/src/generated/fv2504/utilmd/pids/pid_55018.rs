...
pub struct Pid55018Sg2 {
    pub nad: Option<OwnedSegment>,
    pub sg3_ic: Vec<Pid55018Sg3Ic>,
}

/// SG3 — Funktion des Ansprechpartners, Code
/// Qualifiers: IC
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55018Sg3Ic {
...
pub struct Pid55018 {
    ...
    pub sg2: Vec<Pid55018Sg2>,
    pub sg4: Vec<Pid55018Sg4>,
}
...
impl Pid55018Sg2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55018Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
...
impl Pid55018Sg4 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55018Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        Some(Self {
            dtm,
...
impl Pid55018 {
    ...
    pub fn from_segments(segments: &[OwnedSegment]) -> Result<Self, SegmentNotFound> {
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55018Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55018Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
