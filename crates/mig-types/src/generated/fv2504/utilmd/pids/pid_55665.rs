...
impl Pid55665Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55665Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55665Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55665Sg5Z16::from_segments(segments, cursor) {
            sg5_z16.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55665Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_za1_za2 = Vec::new();
        while let Some(item) = Pid55665Sg8Za1Za2::from_segments(segments, cursor) {
            sg8_za1_za2.push(item);
        }
        let mut sg8_zb5_zb6 = Vec::new();
        while let Some(item) = Pid55665Sg8Zb5Zb6::from_segments(segments, cursor) {
...
impl Pid55665Sg8Za1Za2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55665Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self {
            pia,
...
impl Pid55665 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55665Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55665Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
