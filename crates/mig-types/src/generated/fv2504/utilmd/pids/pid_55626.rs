...
impl Pid55626Sg2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55626Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
...
impl Pid55626Sg4 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55626Sg5Z17::from_segments(segments, cursor) {
            sg5_z17.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55626Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_zg6_zg7 = Vec::new();
        while let Some(item) = Pid55626Sg8Zg6Zg7::from_segments(segments, cursor) {
...
impl Pid55626Sg8Zg6Zg7 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55626Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
...
impl Pid55626 {
    ...
    pub fn from_segments(segments: &[OwnedSegment]) -> Result<Self, SegmentNotFound> {
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55626Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55626Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
