...
impl Pid55688Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55688Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55688Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55688Sg5Z16::from_segments(segments, cursor) {
            sg5_z16.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55688Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z01 = Vec::new();
        while let Some(item) = Pid55688Sg8Z01::from_segments(segments, cursor) {
            sg8_z01.push(item);
        }
        Some(Self {
            ide,
...
impl Pid55688Sg8Z01 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55688Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self {
            seq,
...
impl Pid55688 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55688Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55688Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
