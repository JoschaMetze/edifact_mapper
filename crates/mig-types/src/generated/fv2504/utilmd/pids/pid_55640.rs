...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55640Sg2 {
    pub nad: Option<OwnedSegment>,
    pub sg3_ic: Vec<Pid55640Sg3Ic>,
}

/// SG3 — Funktion des Ansprechpartners, Code
/// Qualifiers: IC
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55640Sg3Ic {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55640Sg4 {
    pub ide: Option<OwnedSegment>,
    pub sts: Option<OwnedSegment>,
    pub sg5_z16: Vec<Pid55640Sg5Z16>,
    pub sg6: Vec<Pid55640Sg6>,
    pub sg8_z02: Vec<Pid55640Sg8Z02>,
    pub sg8_z59: Vec<Pid55640Sg8Z59>,
}

/// SG5 — Ortsangabe, Qualifier
/// Qualifiers: Z16
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55640Sg5Z16 {
    pub loc: Option<OwnedSegment>,
}

/// SG6 — Referenz, Qualifier
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55640Sg6 {
...
/// Qualifiers: Z02
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55640Sg8Z02 {
    pub pia: Option<OwnedSegment>,
    pub seq: Option<OwnedSegment>,
    pub sg10: Vec<Pid55640Sg10>,
}

/// SG8 — Handlung, Code
/// Qualifiers: Z59
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55640Sg8Z59 {
    pub pia: Option<OwnedSegment>,
    pub seq: Option<OwnedSegment>,
    pub sg10: Vec<Pid55640Sg10>,
}
...
pub struct Pid55640 {
    ...
    pub sg2: Vec<Pid55640Sg2>,
    pub sg4: Vec<Pid55640Sg4>,
}
...
impl Pid55640Sg2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55640Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
...
impl Pid55640Sg4 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55640Sg5Z16::from_segments(segments, cursor) {
            sg5_z16.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55640Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z02 = Vec::new();
        while let Some(item) = Pid55640Sg8Z02::from_segments(segments, cursor) {
            sg8_z02.push(item);
        }
        let mut sg8_z59 = Vec::new();
        while let Some(item) = Pid55640Sg8Z59::from_segments(segments, cursor) {
            sg8_z59.push(item);
        }
        Some(Self {
            ide,
...
impl Pid55640Sg8Z02 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55640Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
...
impl Pid55640 {
    ...
    pub fn from_segments(segments: &[OwnedSegment]) -> Result<Self, SegmentNotFound> {
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55640Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55640Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
