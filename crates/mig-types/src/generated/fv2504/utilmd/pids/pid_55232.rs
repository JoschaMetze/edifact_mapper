...
impl Pid55232Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55232Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55232Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55232Sg5Z18::from_segments(segments, cursor) {
            sg5_z18.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55232Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_zh1_zh2 = Vec::new();
        while let Some(item) = Pid55232Sg8Zh1Zh2::from_segments(segments, cursor) {
            sg8_zh1_zh2.push(item);
        }
        Some(Self {
            ide,
            sts,
...
impl Pid55232Sg8Zh1Zh2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55232Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self {
            seq,
...
impl Pid55232 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55232Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55232Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
