...
impl Pid55652Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55652Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55652Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55652Sg5Z21::from_segments(segments, cursor) {
            sg5_z21.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55652Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z17 = Vec::new();
        while let Some(item) = Pid55652Sg8Z17::from_segments(segments, cursor) {
            sg8_z17.push(item);
        }
        Some(Self {
            ide,
...
impl Pid55652Sg8Z17 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55652Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self {
            pia,
...
impl Pid55652 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55652Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55652Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
