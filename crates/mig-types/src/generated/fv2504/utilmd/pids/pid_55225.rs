...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55225Sg2 {
    pub nad: Option<OwnedSegment>,
    pub sg3_ic: Vec<Pid55225Sg3Ic>,
}

/// SG3 — Funktion des Ansprechpartners, Code
/// Qualifiers: IC
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55225Sg3Ic {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55225Sg4 {
    pub ide: Option<OwnedSegment>,
    pub sts: Option<OwnedSegment>,
    pub sg5_z18: Vec<Pid55225Sg5Z18>,
    pub sg6: Vec<Pid55225Sg6>,
    pub sg8_z71: Vec<Pid55225Sg8Z71>,
}

/// SG5 — Ortsangabe, Qualifier
/// Qualifiers: Z18
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55225Sg5Z18 {
    pub loc: Option<OwnedSegment>,
}

/// SG6 — Referenz, Qualifier
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55225Sg6 {
...
pub struct Pid55225 {
    ...
    pub sg2: Vec<Pid55225Sg2>,
    pub sg4: Vec<Pid55225Sg4>,
}
...
impl Pid55225Sg2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55225Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
...
impl Pid55225Sg4 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55225Sg5Z18::from_segments(segments, cursor) {
            sg5_z18.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55225Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z71 = Vec::new();
        while let Some(item) = Pid55225Sg8Z71::from_segments(segments, cursor) {
            sg8_z71.push(item);
        }
        Some(Self {
            ide,
...
impl Pid55225Sg8Z71 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55225Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
...
impl Pid55225 {
    ...
    pub fn from_segments(segments: &[OwnedSegment]) -> Result<Self, SegmentNotFound> {
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55225Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55225Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
