...
impl Pid55674Sg2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55674Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
...
impl Pid55674Sg4 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55674Sg5Z16::from_segments(segments, cursor) {
            sg5_z16.push(item);
        }
        let mut sg5_z21 = Vec::new();
        while let Some(item) = Pid55674Sg5Z21::from_segments(segments, cursor) {
            sg5_z21.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55674Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z01_z98 = Vec::new();
        while let Some(item) = Pid55674Sg8Z01Z98::from_segments(segments, cursor) {
            sg8_z01_z98.push(item);
        }
        let mut sg8_z15 = Vec::new();
        while let Some(item) = Pid55674Sg8Z15::from_segments(segments, cursor) {
            sg8_z15.push(item);
        }
        Some(Self {
            ide,
...
impl Pid55674Sg8Z01Z98 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55674Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self { seq, sg10 })
    }
...
impl Pid55674 {
    ...
    pub fn from_segments(segments: &[OwnedSegment]) -> Result<Self, SegmentNotFound> {
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55674Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55674Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
