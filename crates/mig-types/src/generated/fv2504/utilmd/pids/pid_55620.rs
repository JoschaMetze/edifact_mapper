...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55620Sg2 {
    pub nad: Option<OwnedSegment>,
    pub sg3_ic: Vec<Pid55620Sg3Ic>,
}

/// SG3 — Funktion des Ansprechpartners, Code
/// Qualifiers: IC
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55620Sg3Ic {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55620Sg4 {
    pub ide: Option<OwnedSegment>,
    pub sts: Option<OwnedSegment>,
    pub sg5_z17: Vec<Pid55620Sg5Z17>,
    pub sg6: Vec<Pid55620Sg6>,
    pub sg8_z18: Vec<Pid55620Sg8Z18>,
}

/// SG5 — Ortsangabe, Qualifier
/// Qualifiers: Z17
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55620Sg5Z17 {
    pub loc: Option<OwnedSegment>,
}

/// SG6 — Referenz, Qualifier
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55620Sg6 {
...
/// Qualifiers: Z18
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55620Sg8Z18 {
    pub rff: Option<OwnedSegment>,
    pub seq: Option<OwnedSegment>,
    pub sg10: Vec<Pid55620Sg10>,
}
...
pub struct Pid55620 {
    ...
    pub sg2: Vec<Pid55620Sg2>,
    pub sg4: Vec<Pid55620Sg4>,
}
...
impl Pid55620Sg2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55620Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
...
impl Pid55620Sg4 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55620Sg5Z17::from_segments(segments, cursor) {
            sg5_z17.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55620Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z18 = Vec::new();
        while let Some(item) = Pid55620Sg8Z18::from_segments(segments, cursor) {
            sg8_z18.push(item);
        }
        Some(Self {
            ide,
...
impl Pid55620Sg8Z18 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55620Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
...
impl Pid55620 {
    ...
    pub fn from_segments(segments: &[OwnedSegment]) -> Result<Self, SegmentNotFound> {
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55620Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55620Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
