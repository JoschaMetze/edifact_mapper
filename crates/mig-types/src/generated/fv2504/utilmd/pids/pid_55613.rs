...
impl Pid55613Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55613Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55613Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55613Sg5Z16::from_segments(segments, cursor) {
            sg5_z16.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55613Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z01_z98 = Vec::new();
        while let Some(item) = Pid55613Sg8Z01Z98::from_segments(segments, cursor) {
            sg8_z01_z98.push(item);
        }
        let mut sg8_z21 = Vec::new();
        while let Some(item) = Pid55613Sg8Z21::from_segments(segments, cursor) {
            sg8_z21.push(item);
        }
        Some(Self {
            ide,
...
impl Pid55613Sg8Z01Z98 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55613Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        let mut sg9 = Vec::new();
        while let Some(item) = Pid55613Sg9::from_segments(segments, cursor) {
            sg9.push(item);
        }
        Some(Self {
            seq,
...
impl Pid55613 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55613Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55613Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
