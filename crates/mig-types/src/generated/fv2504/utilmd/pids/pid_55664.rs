...
impl Pid55664Sg2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55664Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
...
impl Pid55664Sg4 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55664Sg5Z18::from_segments(segments, cursor) {
            sg5_z18.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55664Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_za9_zb0 = Vec::new();
        while let Some(item) = Pid55664Sg8Za9Zb0::from_segments(segments, cursor) {
            sg8_za9_zb0.push(item);
        }
        let mut sg8_za7_za8 = Vec::new();
        while let Some(item) = Pid55664Sg8Za7Za8::from_segments(segments, cursor) {
            sg8_za7_za8.push(item);
        }
        let mut sg8_zg8_zg9 = Vec::new();
        while let Some(item) = Pid55664Sg8Zg8Zg9::from_segments(segments, cursor) {
...
impl Pid55664Sg8Za7Za8 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55664Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
...
impl Pid55664 {
    ...
    pub fn from_segments(segments: &[OwnedSegment]) -> Result<Self, SegmentNotFound> {
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55664Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55664Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
