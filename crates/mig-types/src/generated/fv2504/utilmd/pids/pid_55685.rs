...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55685Sg2 {
    pub nad: Option<OwnedSegment>,
    pub sg3_ic: Vec<Pid55685Sg3Ic>,
}

/// SG3 — Funktion des Ansprechpartners, Code
/// Qualifiers: IC
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55685Sg3Ic {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55685Sg4 {
    pub ide: Option<OwnedSegment>,
    pub sts: Option<OwnedSegment>,
    pub sg5_z16: Vec<Pid55685Sg5Z16>,
    pub sg6: Vec<Pid55685Sg6>,
    pub sg8_za1_za2: Vec<Pid55685Sg8Za1Za2>,
}

/// SG5 — Ortsangabe, Qualifier
/// Qualifiers: Z16
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55685Sg5Z16 {
    pub loc: Option<OwnedSegment>,
}

/// SG6 — Referenz, Qualifier
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55685Sg6 {
...
pub struct Pid55685 {
    ...
    pub sg2: Vec<Pid55685Sg2>,
    pub sg4: Vec<Pid55685Sg4>,
}
...
impl Pid55685Sg2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55685Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
...
impl Pid55685Sg4 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55685Sg5Z16::from_segments(segments, cursor) {
            sg5_z16.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55685Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_za1_za2 = Vec::new();
        while let Some(item) = Pid55685Sg8Za1Za2::from_segments(segments, cursor) {
...
impl Pid55685Sg8Za1Za2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55685Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
...
impl Pid55685 {
    ...
    pub fn from_segments(segments: &[OwnedSegment]) -> Result<Self, SegmentNotFound> {
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55685Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55685Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
