...
impl Pid55238Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55238Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55238Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55238Sg5Z16::from_segments(segments, cursor) {
            sg5_z16.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55238Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z01 = Vec::new();
        while let Some(item) = Pid55238Sg8Z01::from_segments(segments, cursor) {
            sg8_z01.push(item);
        }
        Some(Self {
            dtm,
...
impl Pid55238Sg8Z01 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55238Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self {
            rff,
...
impl Pid55238 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55238Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55238Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
