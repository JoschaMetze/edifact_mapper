...
impl Pid55653Sg2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55653Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
...
impl Pid55653Sg4 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55653Sg12Z05::from_segments(segments, cursor) {
            sg12_z05.push(item);
        }
        let mut sg5_z17 = Vec::new();
        while let Some(item) = Pid55653Sg5Z17::from_segments(segments, cursor) {
            sg5_z17.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55653Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z18 = Vec::new();
        while let Some(item) = Pid55653Sg8Z18::from_segments(segments, cursor) {
            sg8_z18.push(item);
        }
        let mut sg8_z03 = Vec::new();
        while let Some(item) = Pid55653Sg8Z03::from_segments(segments, cursor) {
            sg8_z03.push(item);
        }
        let mut sg8_z20 = Vec::new();
        while let Some(item) = Pid55653Sg8Z20::from_segments(segments, cursor) {
            sg8_z20.push(item);
        }
        let mut sg8_z04 = Vec::new();
        while let Some(item) = Pid55653Sg8Z04::from_segments(segments, cursor) {
            sg8_z04.push(item);
        }
        let mut sg8_z13 = Vec::new();
        while let Some(item) = Pid55653Sg8Z13::from_segments(segments, cursor) {
            sg8_z13.push(item);
        }
        Some(Self {
            ide,
...
impl Pid55653Sg8Z03 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55653Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
...
impl Pid55653 {
    ...
    pub fn from_segments(segments: &[OwnedSegment]) -> Result<Self, SegmentNotFound> {
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55653Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55653Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
