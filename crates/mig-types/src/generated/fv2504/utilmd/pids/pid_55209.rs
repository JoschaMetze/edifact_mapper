...
impl Pid55209Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55209Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55209Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55209Sg5Z15::from_segments(segments, cursor) {
            sg5_z15.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55209Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z24 = Vec::new();
        while let Some(item) = Pid55209Sg8Z24::from_segments(segments, cursor) {
            sg8_z24.push(item);
        }
        let mut sg8_z25 = Vec::new();
        while let Some(item) = Pid55209Sg8Z25::from_segments(segments, cursor) {
            sg8_z25.push(item);
        }
        Some(Self {
            dtm,
...
impl Pid55209Sg8Z24 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55209Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self {
            seq,
...
impl Pid55209 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55209Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55209Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
