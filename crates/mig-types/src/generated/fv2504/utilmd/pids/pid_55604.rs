...
impl Pid55604Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55604Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55604Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55604Sg12Vy::from_segments(segments, cursor) {
            sg12_vy.push(item);
        }
        let mut sg5_z16 = Vec::new();
        while let Some(item) = Pid55604Sg5Z16::from_segments(segments, cursor) {
            sg5_z16.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55604Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        Some(Self {
            ftx,
...
impl Pid55604 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55604Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55604Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
