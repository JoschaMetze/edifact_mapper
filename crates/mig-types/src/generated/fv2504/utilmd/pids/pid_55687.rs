...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55687Sg2 {
    pub nad: Option<OwnedSegment>,
    pub sg3_ic: Vec<Pid55687Sg3Ic>,
}

/// SG3 — Funktion des Ansprechpartners, Code
/// Qualifiers: IC
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55687Sg3Ic {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55687Sg4 {
    pub ide: Option<OwnedSegment>,
    pub sts: Option<OwnedSegment>,
    pub sg5_z21: Vec<Pid55687Sg5Z21>,
    pub sg6: Vec<Pid55687Sg6>,
    pub sg8_z99_za0: Vec<Pid55687Sg8Z99Za0>,
}

/// SG5 — Ortsangabe, Qualifier
/// Qualifiers: Z21
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55687Sg5Z21 {
    pub loc: Option<OwnedSegment>,
}

/// SG6 — Referenz, Qualifier
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid55687Sg6 {
...
pub struct Pid55687 {
    ...
    pub sg2: Vec<Pid55687Sg2>,
    pub sg4: Vec<Pid55687Sg4>,
}
...
impl Pid55687Sg2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55687Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
...
impl Pid55687Sg4 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55687Sg5Z21::from_segments(segments, cursor) {
            sg5_z21.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55687Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z99_za0 = Vec::new();
        while let Some(item) = Pid55687Sg8Z99Za0::from_segments(segments, cursor) {
...
impl Pid55687Sg8Z99Za0 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55687Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
...
impl Pid55687 {
    ...
    pub fn from_segments(segments: &[OwnedSegment]) -> Result<Self, SegmentNotFound> {
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55687Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55687Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
