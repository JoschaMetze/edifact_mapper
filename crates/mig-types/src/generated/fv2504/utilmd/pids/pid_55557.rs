...
impl Pid55557Sg2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55557Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
...
impl Pid55557Sg4 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55557Sg5Z16::from_segments(segments, cursor) {
            sg5_z16.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55557Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z76 = Vec::new();
        while let Some(item) = Pid55557Sg8Z76::from_segments(segments, cursor) {
            sg8_z76.push(item);
        }
        Some(Self {
            ide,
...
impl Pid55557Sg8Z76 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        let mut sg9 = Vec::new();
        while let Some(item) = Pid55557Sg9::from_segments(segments, cursor) {
            sg9.push(item);
        }
...
impl Pid55557 {
    ...
    pub fn from_segments(segments: &[OwnedSegment]) -> Result<Self, SegmentNotFound> {
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55557Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55557Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
