...
impl Pid55655Sg2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55655Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
...
impl Pid55655Sg4 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55655Sg5Z16::from_segments(segments, cursor) {
            sg5_z16.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55655Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_za1_za2 = Vec::new();
        while let Some(item) = Pid55655Sg8Za1Za2::from_segments(segments, cursor) {
            sg8_za1_za2.push(item);
        }
        let mut sg8_zb5_zb6 = Vec::new();
        while let Some(item) = Pid55655Sg8Zb5Zb6::from_segments(segments, cursor) {
...
impl Pid55655Sg8Za1Za2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55655Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
...
impl Pid55655 {
    ...
    pub fn from_segments(segments: &[OwnedSegment]) -> Result<Self, SegmentNotFound> {
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55655Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55655Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
