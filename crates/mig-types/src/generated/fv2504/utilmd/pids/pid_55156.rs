...
impl Pid55156Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55156Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55156Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55156Sg5Z16::from_segments(segments, cursor) {
            sg5_z16.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55156Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z80_z81 = Vec::new();
        while let Some(item) = Pid55156Sg8Z80Z81::from_segments(segments, cursor) {
            sg8_z80_z81.push(item);
        }
        let mut sg8_z85_z86 = Vec::new();
        while let Some(item) = Pid55156Sg8Z85Z86::from_segments(segments, cursor) {
            sg8_z85_z86.push(item);
        }
        let mut sg8_z87_z88 = Vec::new();
        while let Some(item) = Pid55156Sg8Z87Z88::from_segments(segments, cursor) {
...
impl Pid55156Sg8Z80Z81 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55156Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        let mut sg9 = Vec::new();
        while let Some(item) = Pid55156Sg9::from_segments(segments, cursor) {
            sg9.push(item);
        }
        Some(Self {
            seq,
...
impl Pid55156 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55156Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55156Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
