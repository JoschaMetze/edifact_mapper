...
impl Pid55180Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55180Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55180Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55180Sg5Z18::from_segments(segments, cursor) {
            sg5_z18.push(item);
        }
        let mut sg5_z16 = Vec::new();
        while let Some(item) = Pid55180Sg5Z16::from_segments(segments, cursor) {
            sg5_z16.push(item);
        }
        let mut sg5_z22 = Vec::new();
        while let Some(item) = Pid55180Sg5Z22::from_segments(segments, cursor) {
            sg5_z22.push(item);
        }
        let mut sg5_z20 = Vec::new();
        while let Some(item) = Pid55180Sg5Z20::from_segments(segments, cursor) {
            sg5_z20.push(item);
        }
        let mut sg5_z19 = Vec::new();
        while let Some(item) = Pid55180Sg5Z19::from_segments(segments, cursor) {
            sg5_z19.push(item);
        }
        let mut sg5_z17 = Vec::new();
        while let Some(item) = Pid55180Sg5Z17::from_segments(segments, cursor) {
            sg5_z17.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55180Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_zc7_zc8 = Vec::new();
        while let Some(item) = Pid55180Sg8Zc7Zc8::from_segments(segments, cursor) {
            sg8_zc7_zc8.push(item);
        }
        let mut sg8_zc9_zd0 = Vec::new();
        while let Some(item) = Pid55180Sg8Zc9Zd0::from_segments(segments, cursor) {
...
impl Pid55180 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55180Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55180Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
