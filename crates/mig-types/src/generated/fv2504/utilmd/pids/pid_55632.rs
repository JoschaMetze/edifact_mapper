...
impl Pid55632Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55632Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55632Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55632Sg5Z17::from_segments(segments, cursor) {
            sg5_z17.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55632Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z18 = Vec::new();
        while let Some(item) = Pid55632Sg8Z18::from_segments(segments, cursor) {
            sg8_z18.push(item);
        }
        Some(Self {
            ide,
...
impl Pid55632Sg8Z18 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55632Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self {
            seq,
...
impl Pid55632 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55632Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55632Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
