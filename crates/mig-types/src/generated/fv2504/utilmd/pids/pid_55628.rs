...
impl Pid55628Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55628Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55628Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55628Sg12Z25::from_segments(segments, cursor) {
            sg12_z25.push(item);
        }
        let mut sg12_z26 = Vec::new();
        while let Some(item) = Pid55628Sg12Z26::from_segments(segments, cursor) {
            sg12_z26.push(item);
        }
        let mut sg12_eo = Vec::new();
        while let Some(item) = Pid55628Sg12Eo::from_segments(segments, cursor) {
            sg12_eo.push(item);
        }
        let mut sg12_ddo = Vec::new();
        while let Some(item) = Pid55628Sg12Ddo::from_segments(segments, cursor) {
            sg12_ddo.push(item);
        }
        let mut sg5_z16 = Vec::new();
        while let Some(item) = Pid55628Sg5Z16::from_segments(segments, cursor) {
            sg5_z16.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55628Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z01 = Vec::new();
        while let Some(item) = Pid55628Sg8Z01::from_segments(segments, cursor) {
            sg8_z01.push(item);
        }
        let mut sg8_z21 = Vec::new();
        while let Some(item) = Pid55628Sg8Z21::from_segments(segments, cursor) {
            sg8_z21.push(item);
        }
        let mut sg8_z08 = Vec::new();
        while let Some(item) = Pid55628Sg8Z08::from_segments(segments, cursor) {
            sg8_z08.push(item);
        }
        let mut sg8_z38 = Vec::new();
        while let Some(item) = Pid55628Sg8Z38::from_segments(segments, cursor) {
            sg8_z38.push(item);
        }
        Some(Self {
            ide,
...
impl Pid55628Sg8Z01 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55628Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        let mut sg9 = Vec::new();
        while let Some(item) = Pid55628Sg9::from_segments(segments, cursor) {
            sg9.push(item);
        }
        Some(Self {
            seq,
...
impl Pid55628 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55628Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55628Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
