...
impl Pid55241Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55241Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55241Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55241Sg5Z16::from_segments(segments, cursor) {
            sg5_z16.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55241Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        Some(Self {
            dtm,
...
impl Pid55241 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55241Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55241Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
