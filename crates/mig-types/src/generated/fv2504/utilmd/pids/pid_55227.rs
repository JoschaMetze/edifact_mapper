...
impl Pid55227Sg2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55227Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
...
impl Pid55227Sg4 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55227Sg5Z18::from_segments(segments, cursor) {
            sg5_z18.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55227Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_zh1_zh2 = Vec::new();
        while let Some(item) = Pid55227Sg8Zh1Zh2::from_segments(segments, cursor) {
...
impl Pid55227Sg8Zh1Zh2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55227Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
...
impl Pid55227 {
    ...
    pub fn from_segments(segments: &[OwnedSegment]) -> Result<Self, SegmentNotFound> {
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55227Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55227Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
