...
impl Pid55656Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55656Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55656Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55656Sg5Z19::from_segments(segments, cursor) {
            sg5_z19.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55656Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_zb1_zb2 = Vec::new();
        while let Some(item) = Pid55656Sg8Zb1Zb2::from_segments(segments, cursor) {
            sg8_zb1_zb2.push(item);
        }
        let mut sg8_zb3_zb4 = Vec::new();
        while let Some(item) = Pid55656Sg8Zb3Zb4::from_segments(segments, cursor) {
...
impl Pid55656Sg8Zb1Zb2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55656Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self {
            seq,
...
impl Pid55656 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55656Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55656Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
