...
impl Pid55639Sg2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55639Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
...
impl Pid55639Sg4 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55639Sg5Z18::from_segments(segments, cursor) {
            sg5_z18.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55639Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z51 = Vec::new();
        while let Some(item) = Pid55639Sg8Z51::from_segments(segments, cursor) {
            sg8_z51.push(item);
        }
        let mut sg8_z57 = Vec::new();
        while let Some(item) = Pid55639Sg8Z57::from_segments(segments, cursor) {
            sg8_z57.push(item);
        }
        let mut sg8_z60 = Vec::new();
        while let Some(item) = Pid55639Sg8Z60::from_segments(segments, cursor) {
            sg8_z60.push(item);
        }
        Some(Self {
            ide,
...
impl Pid55639Sg8Z51 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55639Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self { seq, sg10 })
    }
...
impl Pid55639 {
    ...
    pub fn from_segments(segments: &[OwnedSegment]) -> Result<Self, SegmentNotFound> {
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55639Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55639Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
