...
impl Pid55671Sg2 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55671Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
...
impl Pid55671Sg4 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55671Sg5Z16::from_segments(segments, cursor) {
            sg5_z16.push(item);
        }
        let mut sg5_z21 = Vec::new();
        while let Some(item) = Pid55671Sg5Z21::from_segments(segments, cursor) {
            sg5_z21.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55671Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z80 = Vec::new();
        while let Some(item) = Pid55671Sg8Z80::from_segments(segments, cursor) {
            sg8_z80.push(item);
        }
        let mut sg8_z94 = Vec::new();
        while let Some(item) = Pid55671Sg8Z94::from_segments(segments, cursor) {
            sg8_z94.push(item);
        }
        Some(Self {
            ftx,
...
impl Pid55671Sg8Z80 {
    ...
    pub fn from_segments(segments: &[OwnedSegment], cursor: &mut SegmentCursor) -> Option<Self> {
        ...
        while let Some(item) = Pid55671Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self { seq, sg10 })
    }
...
impl Pid55671 {
    ...
    pub fn from_segments(segments: &[OwnedSegment]) -> Result<Self, SegmentNotFound> {
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55671Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55671Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
