...
impl Pid55553Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55553Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55553Sg4 {
    ...
    pub fn from_segments(
        ...
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55553Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z02 = Vec::new();
        while let Some(item) = Pid55553Sg8Z02::from_segments(segments, cursor) {
            sg8_z02.push(item);
        }
        let mut sg8_z03 = Vec::new();
        while let Some(item) = Pid55553Sg8Z03::from_segments(segments, cursor) {
            sg8_z03.push(item);
        }
        let mut sg8_z20 = Vec::new();
        while let Some(item) = Pid55553Sg8Z20::from_segments(segments, cursor) {
            sg8_z20.push(item);
        }
        Some(Self {
            ftx,
...
impl Pid55553Sg8Z02 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55553Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self {
            pia,
...
impl Pid55553 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55553Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55553Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
