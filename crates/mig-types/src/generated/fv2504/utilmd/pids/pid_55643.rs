...
impl Pid55643Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55643Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55643Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55643Sg12Z07::from_segments(segments, cursor) {
            sg12_z07.push(item);
        }
        let mut sg12_z08 = Vec::new();
        while let Some(item) = Pid55643Sg12Z08::from_segments(segments, cursor) {
            sg12_z08.push(item);
        }
        let mut sg12_z03 = Vec::new();
        while let Some(item) = Pid55643Sg12Z03::from_segments(segments, cursor) {
            sg12_z03.push(item);
        }
        let mut sg12_z05 = Vec::new();
        while let Some(item) = Pid55643Sg12Z05::from_segments(segments, cursor) {
            sg12_z05.push(item);
        }
        let mut sg5_z17 = Vec::new();
        while let Some(item) = Pid55643Sg5Z17::from_segments(segments, cursor) {
            sg5_z17.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55643Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z18 = Vec::new();
        while let Some(item) = Pid55643Sg8Z18::from_segments(segments, cursor) {
            sg8_z18.push(item);
        }
        let mut sg8_z03 = Vec::new();
        while let Some(item) = Pid55643Sg8Z03::from_segments(segments, cursor) {
            sg8_z03.push(item);
        }
        let mut sg8_z20 = Vec::new();
        while let Some(item) = Pid55643Sg8Z20::from_segments(segments, cursor) {
            sg8_z20.push(item);
        }
        let mut sg8_z04 = Vec::new();
        while let Some(item) = Pid55643Sg8Z04::from_segments(segments, cursor) {
            sg8_z04.push(item);
        }
        let mut sg8_z05 = Vec::new();
        while let Some(item) = Pid55643Sg8Z05::from_segments(segments, cursor) {
            sg8_z05.push(item);
        }
        let mut sg8_z06 = Vec::new();
        while let Some(item) = Pid55643Sg8Z06::from_segments(segments, cursor) {
            sg8_z06.push(item);
        }
        let mut sg8_z13 = Vec::new();
        while let Some(item) = Pid55643Sg8Z13::from_segments(segments, cursor) {
            sg8_z13.push(item);
        }
        let mut sg8_z14 = Vec::new();
        while let Some(item) = Pid55643Sg8Z14::from_segments(segments, cursor) {
            sg8_z14.push(item);
        }
        Some(Self {
            ide,
...
impl Pid55643Sg8Z03 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55643Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self {
            rff,
...
impl Pid55643 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55643Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55643Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
