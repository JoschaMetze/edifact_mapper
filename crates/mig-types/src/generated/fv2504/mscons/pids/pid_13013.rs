//! Auto-generated PID 13013 types.
...
pub struct Pid13013Sg2 {
    ...
    pub sg4_ic: Vec<Pid13013Sg4Ic>,
}

/// SG4 — Funktion des Ansprechpartners, Code
/// Qualifiers: IC
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid13013Sg4Ic {
...
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid13013Sg5 {
    pub nad: Option<OwnedSegment>,
    pub sg6_172: Vec<Pid13013Sg6172>,
}

/// SG6 — Ortsangabe, Qualifier
/// Qualifiers: 172
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid13013Sg6172 {
    pub dtm: Option<OwnedSegment>,
    pub loc: Option<OwnedSegment>,
    pub sg9: Vec<Pid13013Sg9>,
}
...
pub struct Pid13013 {
    ...
    pub sg1: Vec<Pid13013Sg1>,
    pub sg2: Vec<Pid13013Sg2>,
    pub sg5: Vec<Pid13013Sg5>,
}
...
impl Pid13013Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid13013Sg4Ic::from_segments(segments, cursor) {
            sg4_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid13013Sg5 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid13013Sg6172::from_segments(segments, cursor) {
            sg6_172.push(item);
        }
        Some(Self {
            nad,
...
impl Pid13013Sg6172 {
    ...
    pub fn from_segments(
        ...
        let mut sg9 = Vec::new();
        while let Some(item) = Pid13013Sg9::from_segments(segments, cursor) {
            sg9.push(item);
        }
        Some(Self {
            dtm,
...
impl Pid13013 {
    ...
    pub fn from_segments(
        ...
        let mut sg1 = Vec::new();
        while let Some(item) = Pid13013Sg1::from_segments(segments, &mut cursor) {
            sg1.push(item);
        }
        let mut sg2 = Vec::new();
        while let Some(item) = Pid13013Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg5 = Vec::new();
        while let Some(item) = Pid13013Sg5::from_segments(segments, &mut cursor) {
            sg5.push(item);
        }
