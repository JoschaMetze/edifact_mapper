...
impl Pid55634Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55634Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55634Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55634Sg12Z51Z52::from_segments(segments, cursor) {
            sg12_z51_z52.push(item);
        }
        let mut sg12_z53_z54 = Vec::new();
        while let Some(item) = Pid55634Sg12Z53Z54::from_segments(segments, cursor) {
            sg12_z53_z54.push(item);
        }
        let mut sg12_z55_z56 = Vec::new();
        while let Some(item) = Pid55634Sg12Z55Z56::from_segments(segments, cursor) {
            sg12_z55_z56.push(item);
        }
        let mut sg12_z57_z58 = Vec::new();
        while let Some(item) = Pid55634Sg12Z57Z58::from_segments(segments, cursor) {
            sg12_z57_z58.push(item);
        }
        let mut sg5_z16 = Vec::new();
        while let Some(item) = Pid55634Sg5Z16::from_segments(segments, cursor) {
            sg5_z16.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55634Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z80_z81 = Vec::new();
        while let Some(item) = Pid55634Sg8Z80Z81::from_segments(segments, cursor) {
            sg8_z80_z81.push(item);
        }
        let mut sg8_z85_z86 = Vec::new();
        while let Some(item) = Pid55634Sg8Z85Z86::from_segments(segments, cursor) {
            sg8_z85_z86.push(item);
        }
        let mut sg8_z87_z88 = Vec::new();
        while let Some(item) = Pid55634Sg8Z87Z88::from_segments(segments, cursor) {
            sg8_z87_z88.push(item);
        }
        let mut sg8_z89_z90 = Vec::new();
        while let Some(item) = Pid55634Sg8Z89Z90::from_segments(segments, cursor) {
            sg8_z89_z90.push(item);
        }
        Some(Self {
            ide,
            sts,
...
impl Pid55634Sg8Z80Z81 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55634Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        let mut sg9 = Vec::new();
        while let Some(item) = Pid55634Sg9::from_segments(segments, cursor) {
            sg9.push(item);
        }
        Some(Self {
            seq,
...
impl Pid55634 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55634Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55634Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
