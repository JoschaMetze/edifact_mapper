...
impl Pid55070Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55070Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55070Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55070Sg5Z15::from_segments(segments, cursor) {
            sg5_z15.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55070Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z22 = Vec::new();
        while let Some(item) = Pid55070Sg8Z22::from_segments(segments, cursor) {
            sg8_z22.push(item);
        }
        let mut sg8_z23 = Vec::new();
        while let Some(item) = Pid55070Sg8Z23::from_segments(segments, cursor) {
            sg8_z23.push(item);
        }
        let mut sg8_z24 = Vec::new();
        while let Some(item) = Pid55070Sg8Z24::from_segments(segments, cursor) {
            sg8_z24.push(item);
        }
        let mut sg8_z25 = Vec::new();
        while let Some(item) = Pid55070Sg8Z25::from_segments(segments, cursor) {
            sg8_z25.push(item);
        }
        Some(Self {
            ide,
...
impl Pid55070Sg8Z22 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55070Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        Some(Self {
            rff,
...
impl Pid55070Sg8Z23 {
    ...
    pub fn from_segments(
        ...
        let mut sg9 = Vec::new();
        while let Some(item) = Pid55070Sg9::from_segments(segments, cursor) {
            sg9.push(item);
        }
        Some(Self {
            pia,
...
impl Pid55070 {
    ...
    pub fn from_segments(
        ...
        let mut sg1 = Vec::new();
        while let Some(item) = Pid55070Sg1::from_segments(segments, &mut cursor) {
            sg1.push(item);
        }
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55070Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55070Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
