...
impl Pid55673Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55673Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55673Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55673Sg5Z16::from_segments(segments, cursor) {
            sg5_z16.push(item);
        }
        let mut sg5_z21 = Vec::new();
        while let Some(item) = Pid55673Sg5Z21::from_segments(segments, cursor) {
            sg5_z21.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55673Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z80_z81 = Vec::new();
        while let Some(item) = Pid55673Sg8Z80Z81::from_segments(segments, cursor) {
            sg8_z80_z81.push(item);
        }
        let mut sg8_z94_z95 = Vec::new();
        while let Some(item) = Pid55673Sg8Z94Z95::from_segments(segments, cursor) {
            sg8_z94_z95.push(item);
        }
        let mut sg8_z85_z86 = Vec::new();
        while let Some(item) = Pid55673Sg8Z85Z86::from_segments(segments, cursor) {
            sg8_z85_z86.push(item);
        }
        let mut sg8_z87_z88 = Vec::new();
        while let Some(item) = Pid55673Sg8Z87Z88::from_segments(segments, cursor) {
            sg8_z87_z88.push(item);
        }
        let mut sg8_z89_z90 = Vec::new();
        while let Some(item) = Pid55673Sg8Z89Z90::from_segments(segments, cursor) {
...
impl Pid55673Sg8Z80Z81 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55673Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        let mut sg9 = Vec::new();
        while let Some(item) = Pid55673Sg9::from_segments(segments, cursor) {
            sg9.push(item);
        }
        Some(Self {
            seq,
...
impl Pid55673 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55673Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55673Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
