...
impl Pid55224Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55224Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55224Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55224Sg5Z15::from_segments(segments, cursor) {
            sg5_z15.push(item);
        }
        let mut sg5_z16 = Vec::new();
        while let Some(item) = Pid55224Sg5Z16::from_segments(segments, cursor) {
            sg5_z16.push(item);
        }
        let mut sg5_z21 = Vec::new();
        while let Some(item) = Pid55224Sg5Z21::from_segments(segments, cursor) {
            sg5_z21.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55224Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        let mut sg8_z22 = Vec::new();
        while let Some(item) = Pid55224Sg8Z22::from_segments(segments, cursor) {
            sg8_z22.push(item);
        }
        let mut sg8_z72 = Vec::new();
        while let Some(item) = Pid55224Sg8Z72::from_segments(segments, cursor) {
            sg8_z72.push(item);
        }
        Some(Self {
            ide,
...
impl Pid55224Sg8Z72 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55224Sg10::from_segments(segments, cursor) {
            sg10.push(item);
        }
        let mut sg9 = Vec::new();
        while let Some(item) = Pid55224Sg9::from_segments(segments, cursor) {
            sg9.push(item);
        }
        Some(Self {
            seq,
...
impl Pid55224 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55224Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55224Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
