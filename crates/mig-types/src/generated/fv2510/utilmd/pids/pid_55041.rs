...
impl Pid55041Sg2 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55041Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid55041Sg4 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid55041Sg5Z17::from_segments(segments, cursor) {
            sg5_z17.push(item);
        }
        let mut sg6 = Vec::new();
        while let Some(item) = Pid55041Sg6::from_segments(segments, cursor) {
            sg6.push(item);
        }
        Some(Self {
            dtm,
...
impl Pid55041 {
    ...
    pub fn from_segments(
        ...
        let mut sg2 = Vec::new();
        while let Some(item) = Pid55041Sg2::from_segments(segments, &mut cursor) {
            sg2.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid55041Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
