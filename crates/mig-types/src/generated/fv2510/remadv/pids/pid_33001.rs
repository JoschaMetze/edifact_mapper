//! Auto-generated PID 33001 types.
//! Bestätigung
...
pub struct Pid33001Sg1 {
    pub nad: Option<OwnedSegment>,
    pub sg3_ic: Vec<Pid33001Sg3Ic>,
}

/// SG3 — Funktion des Ansprechpartners, Code
/// Qualifiers: IC
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct Pid33001Sg3Ic {
...
pub struct Pid33001 {
    ...
    pub sg1: Vec<Pid33001Sg1>,
    pub sg4: Vec<Pid33001Sg4>,
    pub sg5: Vec<Pid33001Sg5>,
}
...
impl Pid33001Sg1 {
    ...
    pub fn from_segments(
        ...
        while let Some(item) = Pid33001Sg3Ic::from_segments(segments, cursor) {
            sg3_ic.push(item);
        }
        Some(Self {
            nad,
...
impl Pid33001Sg5 {
    ...
    pub fn from_segments(
        ...
        if doc.is_none() && dtm.is_none() && moa.is_none() {
            cursor.restore(saved);
            return None;
        }
        Some(Self {
...
impl Pid33001 {
    ...
    pub fn from_segments(
        ...
        let mut sg1 = Vec::new();
        while let Some(item) = Pid33001Sg1::from_segments(segments, &mut cursor) {
            sg1.push(item);
        }
        let mut sg4 = Vec::new();
        while let Some(item) = Pid33001Sg4::from_segments(segments, &mut cursor) {
            sg4.push(item);
        }
        let mut sg5 = Vec::new();
        while let Some(item) = Pid33001Sg5::from_segments(segments, &mut cursor) {
            sg5.push(item);
        }
