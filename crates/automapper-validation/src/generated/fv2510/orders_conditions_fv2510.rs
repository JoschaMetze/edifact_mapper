...
// AHB: xml-migs-and-ahbs/FV2510/ORDERS_AHB_1_1_Fehlerkorrektur_20250623.xml
// Generated: 2026-03-12T11:22:20Z
// </auto-generated>
...
/// Generated condition evaluator for ORDERS FV2510.
...
impl ConditionEvaluator for OrdersConditionEvaluatorFV2510 {
    ...
    fn is_known(&self, condition: u32) -> bool {
        matches!(condition, 1 | 2 | 6 | 7 | 9 | 12 | 13 | 15 | 16 | 17 | 18 | 19 | 21 | 23 | 24 | 26 | 27 | 28 | 29 | 33 | 34 | 35 | 36 | 38 | 45 | 46 | 47 | 51 | 54 | 55 | 56 | 57 | 60 | 61 | 62 | 63 | 64 | 65 | 67 | 68 | 69 | 70 | 76 | 77 | 78 | 79 | 80 | 81 | 82 | 83 | 84 | 85 | 86 | 87 | 91 | 93 | 94 | 95 | 96 | 97 | 99 | 100 | 101 | 102 | 103 | 104 | 105 | 106 | 107 | 108 | 109 | 110 | 112 | 113 | 114 | 115 | 117 | 118 | 119 | 120 | 121 | 122 | 123 | 124 | 125 | 126 | 127 | 128 | 129 | 130 | 131 | 132 | 133 | 134 | 135 | 136 | 137 | 138 | 139 | 140 | 141 | 142 | 143 | 147 | 148 | 152 | 153 | 154 | 155 | 156 | 157 | 158 | 159 | 160 | 161 | 162 | 163 | 164 | 165 | 166 | 167 | 168 | 169 | 170 | 171 | 172 | 173 | 174 | 175 | 176 | 177 | 178 | 179 | 180 | 181 | 182 | 490 | 491 | 492 | 493 | 494 | 495 | 500 | 501 | 503 | 506 | 507 | 514 | 515 | 517 | 518 | 519 | 521 | 522 | 523 | 525 | 527 | 530 | 531 | 532 | 533 | 535 | 536 | 539 | 540 | 542 | 543 | 545 | 547 | 548 | 549 | 550 | 551 | 552 | 553 | 554 | 555 | 557 | 558 | 559 | 560 | 561 | 562 | 563 | 564 | 566 | 567 | 568 | 569 | 570 | 571 | 572 | 573 | 574 | 575 | 576 | 577 | 578 | 579 | 580 | 591 | 592 | 903 | 906 | 911 | 914 | 922 | 930 | 931 | 932 | 933 | 934 | 935 | 939 | 940 | 950 | 951 | 955 | 960 | 961 | 962 | 967 | 2001 | 2002 | 2003 | 2004 | 2005 | 2006 | 2007 | 2044 | 2050 | 2060 | 2061 | 2062 | 2063 | 2064 | 2065 | 2066 | 2088 | 2089 | 2090 | 2092 | 2094 | 2095 | 2096 | 2097 | 2098 | 2099)
    }
}
...
impl OrdersConditionEvaluatorFV2510 {
    ...
    fn evaluate_129(&self, ctx: &EvaluationContext) -> ConditionResult {
        ctx.external
            .evaluate("messprodukt_in_smgw_typ2_konfigurationsliste")
    }
    ...
    fn evaluate_141(&self, ctx: &EvaluationContext) -> ConditionResult {
        ctx.external
            .evaluate("messprodukt_position_code_in_typ2_art_der_werte_liste")
    }
    ...
    fn evaluate_142(&self, ctx: &EvaluationContext) -> ConditionResult {
        ctx.external
            .evaluate("smgw_konfigurationsprodukt_ausloeser_schwellwert")
    }
    ...
    fn evaluate_152(&self, ctx: &EvaluationContext) -> ConditionResult {
        ctx.external
            .evaluate("messlokationsprodukt_hat_weitere_energieflussrichtung")
    }
    ...
    fn evaluate_165(&self, ctx: &EvaluationContext) -> ConditionResult {
        ctx.external
            .evaluate("tranche_reconfiguration_or_new_formation")
    }
    ...
    fn evaluate_179(&self, ctx: &EvaluationContext) -> ConditionResult {
        ctx.external
            .evaluate("abrechnungsdaten_einspeisung_lieferant")
    }
    ...
    fn evaluate_180(&self, ctx: &EvaluationContext) -> ConditionResult {
        ctx.external
            .evaluate("product_code_in_abrechnungsdaten_list")
    }
