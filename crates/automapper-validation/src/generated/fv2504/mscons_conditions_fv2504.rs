...
// Generated: 2026-03-12T10:12:37Z
// </auto-generated>
...
impl ConditionEvaluator for MsconsConditionEvaluatorFV2504 {
    ...
    fn is_known(&self, condition: u32) -> bool {
        matches!(condition, 1 | 2 | 11 | 12 | 17 | 18 | 22 | 27 | 28 | 32 | 33 | 35 | 36 | 38 | 42 | 45 | 46 | 48 | 49 | 50 | 51 | 62 | 67 | 68 | 69 | 70 | 71 | 72 | 73 | 77 | 78 | 79 | 80 | 81 | 83 | 84 | 85 | 86 | 87 | 88 | 90 | 91 | 92 | 93 | 94 | 95 | 96 | 97 | 98 | 99 | 100 | 101 | 108 | 111 | 113 | 117 | 118 | 119 | 121 | 125 | 126 | 127 | 128 | 129 | 130 | 131 | 132 | 133 | 134 | 135 | 138 | 141 | 142 | 143 | 144 | 145 | 146 | 147 | 148 | 149 | 150 | 490 | 491 | 492 | 493 | 494 | 495 | 501 | 502 | 506 | 509 | 510 | 511 | 512 | 513 | 514 | 515 | 516 | 518 | 519 | 520 | 522 | 523 | 524 | 525 | 526 | 528 | 529 | 530 | 531 | 532 | 535 | 538 | 541 | 543 | 544 | 545 | 546 | 547 | 551 | 553 | 554 | 556 | 557 | 558 | 559 | 560 | 566 | 567 | 568 | 569 | 570 | 571 | 572 | 573 | 574 | 575 | 576 | 577 | 902 | 904 | 905 | 906 | 907 | 908 | 909 | 910 | 917 | 918 | 922 | 925 | 931 | 932 | 933 | 934 | 935 | 937 | 939 | 940 | 950 | 951 | 960 | 2001 | 2002 | 2003)
    }
}
...
impl MsconsConditionEvaluatorFV2504 {
    ...
    fn evaluate_130(&self, _ctx: &EvaluationContext) -> ConditionResult {
        ...
        // Reason: Requires DST-aware datetime arithmetic: compute the minute difference between DTM+7 (Nutzungszeitpunkt, CCYYMMDDHHMM) and DTM+60 or DTM+9 in the same SG10 group instance, then apply different upper limits depending on whether a summer→winter (≤1500 min) or winter→summer (≤1380 min) or no-transition (≤1439 min) boundary is crossed. This requires parsing UTC timestamps, converting to epoch-minutes, and detecting whether a CET/CEST DST transition falls between the two points — none of which is supported by the available helper API. Exceeds current implementation capacity.
