...
// Generated: 2026-03-11T12:51:21Z
// </auto-generated>
...
impl OrdchgConditionEvaluatorFV2504 {
    ...
    fn evaluate_494(&self, ctx: &EvaluationContext) -> ConditionResult {
        ...
        // Reason: Temporal validation rule: the date must be the document creation time or earlier. Cannot evaluate purely from EDIFACT — requires external knowledge of the actual creation timestamp to compare against. This is a constraint note, not a boolean condition derivable from message content.
    ...
    fn evaluate_500(&self, ctx: &EvaluationContext) -> ConditionResult {
        ...
        // Reason: Hinweis (note): specifies that the document number comes from BGM DE1004 of the original ORDERS message. This is a population instruction for editors, not an evaluatable boolean condition.
        ConditionResult::Unknown
    }
    ...
    fn evaluate_501(&self, ctx: &EvaluationContext) -> ConditionResult {
        ...
        // Reason: Hinweis (note): specifies that the value originates from BGM+Z33 DE1004 of the IFTSTA message conveying the Entsperrauftrag. Cross-message reference; cannot be evaluated from the ORDCHG message alone.
        ConditionResult::Unknown
    }
    ...
    fn evaluate_502(&self, ctx: &EvaluationContext) -> ConditionResult {
        ...
        // Reason: Hinweis (note): specifies that the Vorgangsnummer comes from CNI DE1490 of the IFTSTA with BGM+Z33. Cross-message reference; cannot be evaluated from the ORDCHG message alone.
        ConditionResult::Unknown
    }
    ...
    fn evaluate_503(&self, ctx: &EvaluationContext) -> ConditionResult {
        ...
        // Reason: Hinweis (note): only one piece of information may be transmitted in DE3148. This is a cardinality constraint/editorial note, not a boolean condition to evaluate at the condition level. Validation belongs in a separate schema constraint check.
        ConditionResult::Unknown
    }
