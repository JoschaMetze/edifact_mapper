...
// Generated: 2026-03-11T13:09:48Z
// </auto-generated>
...
impl Default for AperakConditionEvaluatorFV2504 {
    fn default() -> Self {
        ...
        external_conditions.insert(500);
        external_conditions.insert(501);
        Self {
            external_conditions,
        }
    }
...
impl AperakConditionEvaluatorFV2504 {
    ...
    fn evaluate_2(&self, ctx: &EvaluationContext) -> ConditionResult {
        ctx.external.evaluate("erroneous_content_present")
    }
    ...
    fn evaluate_6(&self, ctx: &EvaluationContext) -> ConditionResult {
        ctx.external
            .evaluate("error_at_transaction_level_in_iftsta_insrpt_utilmd_utilts")
    }
    ...
    fn evaluate_494(&self, ctx: &EvaluationContext) -> ConditionResult {
        ...
        // Reason: Requires comparing the date in the segment against the document creation timestamp, which is external business context not determinable purely from EDIFACT message content.
    ...
    fn evaluate_502(&self, ctx: &EvaluationContext) -> ConditionResult {
        ...
        // Reason: This is a cardinality constraint note (only one value may be transmitted in DE3148), not an evaluatable boolean condition from message content. Schema validation rather than condition evaluation applies.
        ConditionResult::Unknown
    }
